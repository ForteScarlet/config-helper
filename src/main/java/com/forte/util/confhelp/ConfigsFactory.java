...
public class ConfigsFactory {
     ...
     * @param in   数据的输入流
     */
    public static Configs build(String type, InputStream in, Properties properties, boolean close) throws IOException {
     ...
     * @param in   数据的输入流
     */
    public static Configs build(String type, InputStream in, boolean close) throws IOException {
        return build(type, in, null, close);
    }
     ...
     * @return
     */
    public static Configs build(String type, InputStream in, Properties properties){
        try {
            return build(type, in, properties, false);
        } catch (IOException e) {
     ...
     * @return
     */
    public static Configs build(String type, InputStream in){
        try {
            return build(type, in,false);
        } catch (IOException e) {
            throw new ConfigsHelperException(e);
        }
    }
     ...
     */
    public static Configs build(File file, Properties properties, boolean close) throws IOException {
        if(!file.isFile()){
     ...
     * @param file 文件对象
     */
    public static Configs build(File file, Properties properties) throws IOException {
        return build(file, properties, true);
    }
     ...
     * @param file 文件对象
     */
    public static Configs build(File file) throws IOException {
        return build(file, null, true);
    }
     ...
     * @param close                 是否闭流
     */
    public static Configs build(String resourceAsStreamName, String type, Properties properties, boolean close) throws IOException {
        Objects.requireNonNull(resourceAsStreamName);
        return build(type, ConfigsFactory.class.getResourceAsStream(resourceAsStreamName), properties, close);
    }
     ...
     * @param close                 是否闭流
     */
    public static Configs build(String resourceAsStreamName, String type, boolean close) throws IOException {
        Objects.requireNonNull(resourceAsStreamName);
        return build(type, ConfigsFactory.class.getResourceAsStream(resourceAsStreamName), null, close);
    }
     ...
     * @param close                 是否闭流
     */
    public static Configs build(String resourceAsStreamName, Properties properties, boolean close) throws IOException {
        ...
        return build(resourceAsStreamName, type, properties, close);
    }
     ...
     * @param resourceAsStreamName  路径
     */
    public static Configs build(String resourceAsStreamName, Properties properties) throws IOException {
        return build(resourceAsStreamName, properties, true);
    }
     ...
     * @param resourceAsStreamName  路径
     */
    public static Configs build(String resourceAsStreamName, String type, Properties properties) throws IOException {
        return build(resourceAsStreamName, type, properties, true);
    }
     ...
     * @param resourceAsStreamName  路径
     */
    public static Configs build(String resourceAsStreamName, String type) throws IOException {
        return build(resourceAsStreamName, type, null, true);
    }
     ...
     * @param resourceAsStreamName  路径
     */
    public static Configs build(String resourceAsStreamName) throws IOException {
        return build(resourceAsStreamName, (Properties) null, true);
    }
